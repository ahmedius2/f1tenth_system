...
public:
    PurePursuit() : Node("pure_pursuit_node") {
        ...
        this->declare_parameter("waypoints_path", "/root/ros_docker_shared/ros2_workspace/src/f1tenth_system/pure_pursuit/racelines/nichols_raceline.csv");
...
private:
	...
	std::cout << "The path is:" << waypoints_path;
